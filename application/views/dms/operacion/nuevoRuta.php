<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			...
			<form action="<?= base_url();?>dms/operacion/nuevaruta" id="NuevoRespuesta" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
				<div class="col-md-3">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<select name="cite" id="inputCite" class="form-control" required="required" disabled="disabled">
							<option value=""></option>							
							...
							<?php if (isset($Destinatarios)): ?>
								<?php foreach ($Destinatarios as $destinatario): ?>
									...
									<?php if ($destinatario->idusuario == $Remitente->idusuario): ?>
										<option value=" <?= $destinatario->idusuario; ?> ">
											REPRESENTAR RECEPCIÓN (AUTOENVIARSE)
										</option>									
									<?php endif; ?>									
								<?php endforeach ?>
							<?php endif ?>
