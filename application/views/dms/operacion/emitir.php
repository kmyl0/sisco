				...
				<div class="page-header">
					<h1>
						...
						<div class="pull-right">
							Número de ruta: <?= $id_ruta; ?>
						</div>
					</h1>
				</div>					
			</div>
			<form action="<?= base_url();?>dms/operacion/emitir" id="NuevoRespuesta" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<select name="rutaTipo" id="inputRutaTipo" class="form-control" required="required" disabled="disabled">
							<option value=""></option>							
				...
				<div class="col-md-12">					
					<div class="form-group">
						...
						<input type="text" name="referencia" id="referencia" class="form-control" size="5" maxlength="100" value="<?= $referencia ?>" readonly="True">
					</div>
					<div class="form-group">
