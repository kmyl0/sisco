<form method="POST" action="<?= base_url().'rrhh/user/'.$action; ?>" id="frmAcceso">
	...
	<div class="modal-body">
		...
		<div class="form-group">
			...
			<select name="rol" class="form-control" id="rol">
				<option value="" 				<?php if (@$DatosPersonales->rol == ''): ?>  selected<?php endif ?> >--SELECCIONE UNA OPCION--</option>
				<option value="ADMINISTRADOR" 	<?php if (@$DatosPersonales->rol == '1'): ?> selected<?php endif ?> >ADMINISTRADOR</option>
				<option value="USUARIO" 		<?php if (@$DatosPersonales->rol == '2'): ?> selected<?php endif ?> >USUARIO</option>
				<option value="EMPLEADO" 		<?php if (@$DatosPersonales->rol == '0'): ?> selected<?php endif ?> >EMPLEADO</option>
	    	</select>
		</div>
		<div class="form-group">
			...
			<select name="cfgConductoRegular" class="form-control" id="cfgConductoRegular">
				<option value="" 	<?php if (@$Configuracion->cfgConductoRegular == ''): ?>  selected<?php endif ?> >--SELECCIONE UNA OPCION--</option>
				<option value="1" 	<?php if ($Configuracion->cfgConductoRegular == '1'): ?> selected<?php endif ?> >Global</option>
				<option value="0" 	<?php if ($Configuracion->cfgConductoRegular == '0'): ?> selected<?php endif ?> >Jerarquia</option>
	    	</select>
		</div>
		<div class="form-group">
			<label for="cfgNuevoInforme">Nuevo informe</label>						
			<select name="cfgNuevoInforme" class="form-control" id="cfgNuevoInforme">
				<option value="" 	<?php if (@$Configuracion->cfgNuevoInforme == ''): ?>  selected<?php endif ?> >--SELECCIONE UNA OPCION--</option>
				<option value="1" 	<?php if ($Configuracion->cfgNuevoInforme == '1'): ?> selected<?php endif ?> >Activado</option>
				<option value="0" 	<?php if ($Configuracion->cfgNuevoInforme == '0'): ?> selected<?php endif ?> >Desactivado</option>
	    	</select>
		</div>
		<div class="form-group">
